class MinStack:
    ...
    def push(self, x):
        ...
        if self.top2 is None or len(self.stack) == 0:
			self.top2 = x 
			self.minimum = x
			self.stack.append(x)
        elif x < self.minimum:
    ...
    def pop(self):
        ...
        # if len(self.stack) == 0:
            ...
            n = self.stack[-1]
            if n < self.minimum:
                self.minimum = ( ( 2 * self.minimum ) - n )
            self.stack.pop()
            if(len(self.stack)):
                self.top2 = self.stack[-1]
            else:
                self.top2 = None
                self.minimum = None
...
for i in range(0,arr_len):
    if arr[i] == 'p':
        ...
        i += 1
# stack.push(780809279)
# stack.push(57337424)
# stack.push(998849637)
# stack.getMin()
# stack.pop()
# stack.push(514381243)
# stack.pop()
# stack.pop()
# stack.push(814651044)
# stack.getMin()
# t p P 514381243 p t t t p P 814651044 g
